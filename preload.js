...
const nativeApi = {
  ...
  chooseDefaultSaveFolder: () => ipcRenderer.invoke('choose-default-save-folder'),
  resetDefaultSaveFolder: () => ipcRenderer.invoke('reset-default-save-folder'),
  moveFile: (payload) => ipcRenderer.invoke('move-file', payload),
  duplicateFile: (payload) => ipcRenderer.invoke('duplicate-file', payload),
  ...
  saveLineNumbersPreference: (payload) => ipcRenderer.invoke('save-line-numbers-preference', payload),
  loadLineNumbersPreference: () => ipcRenderer.invoke('load-line-numbers-preference'),
  saveContinuePrefixesPreference: (payload) => ipcRenderer.invoke('save-continue-prefixes-preference', payload),
  loadContinuePrefixesPreference: () => ipcRenderer.invoke('load-continue-prefixes-preference'),
  saveCollapsibleTextPreference: (payload) => ipcRenderer.invoke('save-collapsible-text-preference', payload),
  loadCollapsibleTextPreference: () => ipcRenderer.invoke('load-collapsible-text-preference'),
  listInstalledFontFamilies: () => ipcRenderer.invoke('list-installed-font-families'),
  saveEditorFontPreference: (payload) => ipcRenderer.invoke('save-editor-font-preference', payload),
  loadEditorFontPreference: () => ipcRenderer.invoke('load-editor-font-preference'),
  ...
  saveMindmapPreference: (payload) => ipcRenderer.invoke('save-mindmap-preference', payload),
  loadMindmapPreference: () => ipcRenderer.invoke('load-mindmap-preference'),
  exportMindmapSvg: (payload) => ipcRenderer.invoke('export-mindmap-svg', payload),
  ...
  saveTagManagerPreference: (payload) => ipcRenderer.invoke('save-tag-manager-preference', payload),
  loadTagManagerPreference: () => ipcRenderer.invoke('load-tag-manager-preference'),
  chooseNotesTreeRoot: () => ipcRenderer.invoke('choose-notes-tree-root'),
  readGlobalTags: (payload) => ipcRenderer.invoke('read-global-tags', payload),
  readNotesTree: (payload) => ipcRenderer.invoke('read-notes-tree', payload),
  saveNotesTreePreference: (payload) => ipcRenderer.invoke('save-notes-tree-preference', payload),
  loadNotesTreePreference: () => ipcRenderer.invoke('load-notes-tree-preference'),
